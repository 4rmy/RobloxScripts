if _G.created ~= true then
	...
	-----[Properties]-----
		...
		main.Position = UDim2.new(0.378787875, 0, 0.357224107, 0)
		main.Size = UDim2.new(0, 403, 0, 250)
		...
		BreakGlass.Position = UDim2.new(0, 0, 0, 72)
		...
		AutoRob.Position = UDim2.new(0, 0, 0, 98)
	...
	-----[Scripts]-----
		...
		local function PKAVXW_fake_script() -- border.LocalScript
		...
		coroutine.wrap(PKAVXW_fake_script)()
